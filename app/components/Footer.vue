  ...
  <footer class="w-full">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="py-14 grid grid-cols-12 gap-x-5 gap-y-8">
        <div class="col-span-full xl:col-span-3 relative bg-[#a30000] from-indigo-600 to-violet-600 rounded-2xl gap-12 p-6 xl:w-72 h-96 flex flex-col justify-center items-center">

          <a href="https://pagedone.io/" class=" text-3xl font-bold flex justify-center lg:justify-start">
            <h1 class="text-white">Pamir tradition </h1>
          </a>
          <p class="text-center text-gray-200">These mountains are known as the "Roof of the World" in Persian. They are the second highest in the world after the Himalayas. On the south side of their territory is the Pyandzh River, separating them from Afghanistan..</p>
        ...
        <div class="block text-center xl:text-left xl:py-16 col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-3 xl:pl-5">
          <h4 class="text-lg text-red-500 font-bold mb-9">Get In Touch</h4>
          <ul class="text-gray-900 transition-all duration-500 grid gap-6">
            <li>pamir@tradition.com</li>
            <li>+992931874004</li>
            <li>131/2 Elm adress Pamir(Badakhshan)</li>
          </ul>
        </div>
        <div class="block xl:py-16 col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-3">
          <h4 class="text-lg text-black font-bold mb-9 text-center xl:text-left">Quick Links</h4>
          <div class="flex gap-6 xl:gap-12 max-xl:justify-center">
            <ul class="text-gray-600 transition-all duration-500 grid gap-6">
              <li><a href="javascript:;">About traditions</a></li>
              <li><a href="javascript:;">Tradition Foods</a></li>
            ...
            <ul class="text-gray-600 transition-all duration-500 grid gap-6">
              ...
              <li><a href="javascript:;">Facts</a></li>
              <li><a href="javascript:;">Contact</a></li>
            </ul>
          </div>
        </div>
        <div class="block xl:py-16 col-span-full md:col-span-4 xl:col-span-3">
          <h4 class="text-lg text-red-500 font-bold mb-9 text-center xl:text-left">Newsletter</h4>
          <div class="grid gap-7 ">
            ...
            <button type="submit"
                    class="flex gap-2 justify-center items-center py-3.5 px-7 rounded-full text-white bg-[#a30000] shadow-md w-fit transition-all duration-500 mx-auto xl:mx-0 hover:bg-black">Subscribe<svg
    ...
    <div class="py-4 bg-indigo-50">
      <div class="flex items-center justify-center">
        <span class="text-sm text-gray-800 ">Pamir Tradition@2025   by <a href="https://Pamirtradition.io/">SayfiddinovaBibiaram</a></span>
      </div>
    </div>
